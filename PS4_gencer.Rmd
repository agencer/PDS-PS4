...
Model1 <- glm(win ~ Incumbent + weightexperience, family="binomial", data=poll.data.2)
summary(Model1)
...
####
boxplot(Model1preds ~ poll.data.2$weightexperience, xlab="Weighted Experience", ylab="Predicted Probabilities")
...
equation <- as.formula("win ~ Incumbent + weightexperience")
...
equation.2 <- as.formula("win.factor ~ Incumbent + weightexperience")
...
####
poll.data.2.X <- poll.data.2[,c("win", "weightexperience", "Incumbent")]
